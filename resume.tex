...
\begin{itemize}
  ...
  \item \textbf{Selected Courses}:\ \ \; Compiler Design, Machine Learning, Computer Vision, Deep Learning, Web Programming, Operating Systems, Database Management
\end{itemize}

\mysection{Skills}
\textbf{Programming}: C, C++, Python, Java, OCaml \\
\textbf{Web}:\qquad\quad\ \ \ \ \ \space JavaScript, HTML5, CSS  \\
\textbf{Misc. Tech}: \space\space\space UNIX, Linux, Windows, Docker, Git, Mercurial
...
\textbf{Systems Software Engineer, Kulicke and Soffa Industries} \textit{Fort Washington, PA} \hfill Jun 2021 -- Sep 2022
\begin{itemize}
